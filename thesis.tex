...
\thesissetup{
    ...
    keywords      = {kalibrace, dcc, vlak, vůz, model, senzor, C++, qt, bluetooth, cv},
    TeXkeywords   = {kalibrace, dcc, vlak, vůz, model, senzor, C++, qt, bluetooth, cv},
    ...
    keywordsEn    = {calibration, dcc, car, model, sensor, C++, qt, bluetooth, cv},
    TeXkeywordsEn = {calibration, dcc, car, model, sensor, c++, qt, bluetooth, cv},
