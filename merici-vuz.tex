...
i~korekce vypočítané z~nepřesnosti výstupu LDO, jedná se tedy o~\textit{napětí,
...
kde $i$ je počet pulzů senzoru, $d$ je průměr modelového kola a~$h = 8$ je počet děr
v~kole.
...
odpovídající okamžiku předchozí vzestupné hrany na pinu ICP.} a~tím pádem je
...
BEMF (viz \ref{sec:det-static}) ji okamžitě vykompenzuje. Pokud by uživatel
