...
\caption{Průběh naměřené periody a modelové rychlost v~čase v~analogovém
režimu}
...
\uv{obloukový} trend. Tento jev autor vysvětluje tím, že v~průběhu měření
...
se však ukázalo, že při kalibrování na oválů o dostatečně velkých poloměrech
...
obloucích o malých poloměrech, nabízí autor možnost výběru používaných a
...
I~přes původní útrapy autor těmto výzvám úspěšně čelil, výsledkem jeho práce
je funkční prototyp měřicího vozu.
