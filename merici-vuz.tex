...
produkt, který umožňuje úpravy její elektroniky nejvýše na úrovní výměny
...
vytváří.  Negativem tohoto přístupu je však ale to, že typicky není možné na
počítači, který přijímá signál z~měřícího vozu přes WiFi, být zároveň připojený
...
snižit napěťovým děličem. Při vývoji hardwaru byla v~jednu chvíli překážkou
