...
Pro kompilaci je využit standardní kompilátor `avr-gcc`, pro nahrávání
firmwaru do procesoru je využit opět standardní program `avrdude`. Deska
plošných spojů je osazena programovacím konektorem, procesor je tedy možné
...
\item Zbytek programu jsou pomocné funkce.
\end{enumerate}
